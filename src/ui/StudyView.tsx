...
// P12 Phase A-2: 「ヨコサワレンジ表」セクションは新GTOアプリの「学習」タブと共有するため
// src/ui/study/YokosawaRangeSection.tsx へ抽出した(挙動不変)。他セクションが使う
// SectionTitle/Introもそこからimportする。
import { YokosawaRangeSection, SectionTitle, Intro } from './study/YokosawaRangeSection'
...
// P12 Phase A-2: 「ヨコサワレンジ表」セクション本体は ./study/YokosawaRangeSection.tsx へ移設済み。
