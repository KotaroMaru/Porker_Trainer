...
function features(overrides: Partial<SpotFeatures> = {}): SpotFeatures {
  return {
    ...
    nutsAdvantage: { heroTopPct: 10, villainTopPct: 10 }, equityBuckets: [],
    ...
    targets: null, mdf: null, potOddsRequiredEq: null, sprBucket: { spr: 10, bucket: 'high' },
    sameClass: { comboCount: 10, actionMix: [{ label: 'check', freq: 0.6 }, { label: 'bet33', freq: 0.4 }] },
