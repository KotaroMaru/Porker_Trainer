...
function features(overrides: Partial<SpotFeatures> = {}): SpotFeatures {
  return {
    ...
    boardTexture: { paired: true, suitPattern: 'rainbow', height: 'high', connected: false },
    handClass: 'AIR',
    sdvLevel: 'none',
    ...
    rangeAdvantage: { heroAvg: 0.54, villainAvg: 0.46 },
    nutsAdvantage: { heroTopPct: 23, villainTopPct: 8 },
    equityBuckets: [],
    ...
    sprBucket: { spr: 10, bucket: 'high' },
    sameClass: { comboCount: 10, actionMix: [{ label: 'check', freq: 0.57 }, { label: 'bet33', freq: 0.43 }] },
